...
hsycmsalert_loading_html += "</div>";
let hsycmsalerthtml = { 'model': hsycmsalert_model_html, 'alert': hsycmsalert_alert_html, 'tips': hsycmsalert_tips_html, 'confirm': hsycmsalert_confirm_html, 'success': hsycmsalert_success_html, 'fail': hsycmsalert_fail_html, 'loading': hsycmsalert_loading_html };
var hsycms = function() {
    return {
        open: function(id, txt = '', html) {
            ...
            if (txt != '') { obj.find(".hsycms-model-text").html(txt) }
            obj.show();
            setTimeout(res => { obj.removeClass("hsycms-ani-open") }, 300)
        },
        ...
        confirm: function(txt = '', confirm, concel) {
            ...
            $("body").on("click", ".hsycms-model-btn button", function() {
                ...
                if ($(this).attr("class") == "ok") { confirm() } else { concel() }
            })
        },
        ...
        loading: function(txt) { this.open('loading', txt) },
